...
jQuery(window).load(function(){
   ...
   $("#preloader").fadeOut("slow");
    ...
    //Our AssociatesslickSliderOurAssociates
    $('.slickSliderOurAssociates').slick({
      slidesToShow: 3,
      slidesToScroll: 1,
      autoplay: true,
      autoplaySpeed: 4000,
...
function init() {
    ...
    // For more options see: https://developers.google.com/maps/documentation/javascript/reference#MapOptions
	    ...
	    var myLatLng = new google.maps.LatLng(3.942, 101.432);
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(3.942, 101.432),
        map: map,
		title : 'AGL ASIA PACIFIC SDN BHD'
